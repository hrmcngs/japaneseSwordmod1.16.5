...
import net.mcreator.japanesesword.entity.renderer.HuranRenderer;
...
public class HuranEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("huran").setRegistryName("huran");

	public HuranEntity(JapaneseswordModElements instance) {
		super(instance, 90);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HuranRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -65485, -26368, new Item.Properties().group(BukiItemGroup.tab)).setRegistryName("huran_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(HaItem.block));
