...
import net.mcreator.japanesesword.entity.renderer.Ken2Renderer;
...
public class Ken2Entity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("ken_2").setRegistryName("ken_2");

	public Ken2Entity(JapaneseswordModElements instance) {
		super(instance, 323);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Ken2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(null)).setRegistryName("ken_2_spawn_egg"));
	}
