...
import net.mcreator.japanesesword.entity.renderer.KuyoumuRenderer;
...
public class KuyoumuEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("kuyoumu").setRegistryName("kuyoumu");

	public KuyoumuEntity(JapaneseswordModElements instance) {
		super(instance, 190);
		FMLJavaModLoadingContext.get().getModEventBus().register(new KuyoumuRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("kuyoumu_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 100;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(NorooinokatanaItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(NorooinokatanaItem.block));
