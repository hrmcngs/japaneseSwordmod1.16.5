...
import net.mcreator.japanesesword.procedures.YoumuenteiteigaSiWangsitaShiProcedure;
import net.mcreator.japanesesword.procedures.Katana2Procedure;
...
import net.mcreator.japanesesword.gui.KunoyoumuGui;
import net.mcreator.japanesesword.entity.renderer.YoumuRenderer;
...
public class YoumuEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("youmu").setRegistryName("youmu");

	public YoumuEntity(JapaneseswordModElements instance) {
		super(instance, 51);
		FMLJavaModLoadingContext.get().getModEventBus().register(new YoumuRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -16738048, new Item.Properties().group(BukiItemGroup.tab)).setRegistryName("youmu_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(JapaneseSwordItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(JapaneseSwordItem.block));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(6, new AvoidEntityGoal(this, AgeableEntity.class, (float) 6, 1, 1.2));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, MonsterEntity.class, false, false) {
				...
				public boolean shouldExecute() {
					...
					return super.shouldExecute() && Katana2Procedure.executeProcedure(Stream
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(JapaneseSwordItem.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			YoumuenteiteigaSiWangsitaShiProcedure.executeProcedure(Stream
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("魂魄妖夢");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new KunoyoumuGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
