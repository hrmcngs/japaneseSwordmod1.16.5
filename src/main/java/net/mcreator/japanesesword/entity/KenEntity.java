...
import net.mcreator.japanesesword.procedures.KenenteiteinotitukuGengXinShiProcedure;
import net.mcreator.japanesesword.procedures.KenenteiteigasuponsitaShiProcedure;
import net.mcreator.japanesesword.entity.renderer.KenRenderer;
...
public class KenEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("ken").setRegistryName("ken");

	public KenEntity(JapaneseswordModElements instance) {
		super(instance, 318);
		FMLJavaModLoadingContext.get().getModEventBus().register(new KenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(null)).setRegistryName("ken_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			KenenteiteigasuponsitaShiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			KenenteiteinotitukuGengXinShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
