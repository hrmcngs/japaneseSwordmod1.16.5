...
@OnlyIn(Dist.CLIENT)
public class GGuiWindow extends ContainerScreen<GGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = GGui.guistate;

	public GGuiWindow(GGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 117, this.guiTop + 59, 46, 20, new StringTextComponent("Fuse"), e -> {
			if (true) {
				JapaneseswordMod.PACKET_HANDLER.sendToServer(new GGui.ButtonPressedMessage(0, x, y, z));
				GGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
