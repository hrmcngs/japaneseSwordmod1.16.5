...
import net.mcreator.japanesesword.procedures.WazakigaYasaretatokiProcedure;
...
public class WazaKeyBinding extends JapaneseswordModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.japanesesword.waza", GLFW.GLFW_KEY_N, "key.categories.misc");
