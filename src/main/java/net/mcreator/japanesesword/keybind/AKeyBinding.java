...
import net.mcreator.japanesesword.procedures.AkigaYasaretatokiProcedure;
...
public class AKeyBinding extends JapaneseswordModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.japanesesword.a", GLFW.GLFW_KEY_X, "key.categories.misc");
