...
public class JapaneseswordModElements {
	...
	public JapaneseswordModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == JapaneseswordModElements.ModElement.class)
						elements.add((JapaneseswordModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(JapaneseswordModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new JapaneseswordModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		JapaneseswordMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final JapaneseswordModElements elements;
		protected final int sortid;

		public ModElement(JapaneseswordModElements elements, int sortid) {
