...
import net.mcreator.japanesesword.potion.Doku2PotionEffect;
...
public class DokuBlock extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:doku")
	public static final Block block = null;

	public DokuBlock(JapaneseswordModElements instance) {
		super(instance, 28);
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public Effect getStewEffect() {
			return Doku2PotionEffect.potion;
		}
