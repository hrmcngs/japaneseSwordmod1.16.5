...
public class DaiazyoiBlock extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:daiazyoi")
	public static final Block block = null;

	public DaiazyoiBlock(JapaneseswordModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DaiazyoiBlock.block));
		}
	}
}
