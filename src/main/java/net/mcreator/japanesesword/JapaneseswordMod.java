 ...
 *
 *    Keep the JapaneseswordModElements object in this class and all calls to this object
...
public class JapaneseswordMod {
	...
	public JapaneseswordMod() {
		elements = new JapaneseswordModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new JapaneseswordModFMLBusEvents(this));
	}
	...
	private static class JapaneseswordModFMLBusEvents {
		private final JapaneseswordMod parent;

		JapaneseswordModFMLBusEvents(JapaneseswordMod parent) {
			this.parent = parent;
		}
