...
import net.mcreator.japanesesword.procedures.YuugenkennenteiteigaaitemuwoZhentutaShiProcedure;
import net.mcreator.japanesesword.procedures.YuugenkennKongQiwoYoukuritukusitatokiProcedure;
...
public class YuugenkennItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:yuugenkenn")
	public static final Item block = null;

	public YuugenkennItem(JapaneseswordModElements instance) {
		super(instance, 56);
	}
