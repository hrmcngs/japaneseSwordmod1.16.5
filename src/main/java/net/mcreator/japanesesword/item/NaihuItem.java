...
import net.mcreator.japanesesword.entity.renderer.NaihuRenderer;
...
public class NaihuItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:naihu")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_naihu").setRegistryName("projectile_naihu");

	public NaihuItem(JapaneseswordModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NaihuRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(NaihuItem.block);
		}
