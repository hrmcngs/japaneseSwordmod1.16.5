...
import net.mcreator.japanesesword.procedures.Katana1turuwoShoudeChituteiruJiannoteitukuProcedure;
import net.mcreator.japanesesword.procedures.Katana1enteiteigaaitemuwoZhentutaShiProcedure;
import net.mcreator.japanesesword.procedures.Katana1YoukuritukusitatokiProcedure;
...
public class Katana1Item extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:katana_1")
	public static final Item block = null;

	public Katana1Item(JapaneseswordModElements instance) {
		super(instance, 290);
	}
