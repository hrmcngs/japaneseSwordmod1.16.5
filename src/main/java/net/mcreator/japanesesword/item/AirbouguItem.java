...
public class AirbouguItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:airbougu_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:airbougu_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:airbougu_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:airbougu_boots")
	public static final Item boots = null;

	public AirbouguItem(JapaneseswordModElements instance) {
		super(instance, 207);
	}
