...
import net.mcreator.japanesesword.entity.renderer.NannkRenderer;
import net.mcreator.japanesesword.JapaneseswordModElements;

import java.util.Random;

@JapaneseswordModElements.ModElement.Tag
public class NannkItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:nannk")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_nannk").setRegistryName("projectile_nannk");

	public NannkItem(JapaneseswordModElements instance) {
		super(instance, 70);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NannkRenderer.ModelRegisterHandler());
	}
