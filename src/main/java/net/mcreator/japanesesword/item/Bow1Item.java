...
import net.mcreator.japanesesword.entity.renderer.Bow1Renderer;
import net.mcreator.japanesesword.JapaneseswordModElements;

import java.util.Random;

@JapaneseswordModElements.ModElement.Tag
public class Bow1Item extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:bow_1")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_bow_1").setRegistryName("projectile_bow_1");

	public Bow1Item(JapaneseswordModElements instance) {
		super(instance, 338);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Bow1Renderer.ModelRegisterHandler());
	}
