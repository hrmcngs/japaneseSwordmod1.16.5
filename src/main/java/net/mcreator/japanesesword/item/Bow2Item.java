...
import net.mcreator.japanesesword.entity.renderer.Bow2Renderer;
import net.mcreator.japanesesword.JapaneseswordModElements;

import java.util.Random;

@JapaneseswordModElements.ModElement.Tag
public class Bow2Item extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:bow_2")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_bow_2").setRegistryName("projectile_bow_2");

	public Bow2Item(JapaneseswordModElements instance) {
		super(instance, 339);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Bow2Renderer.ModelRegisterHandler());
	}
