...
import net.mcreator.japanesesword.gui.BGuiWindow;
import net.mcreator.japanesesword.gui.BGui;
...
public class HonnItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:honn")
	public static final Item block = null;

	public HonnItem(JapaneseswordModElements instance) {
		super(instance, 121);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("本");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
