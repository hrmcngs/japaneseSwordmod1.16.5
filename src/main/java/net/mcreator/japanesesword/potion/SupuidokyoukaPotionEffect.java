...
import net.mcreator.japanesesword.procedures.NoroProcedure;
...
public class SupuidokyoukaPotionEffect {
	@ObjectHolder("japanesesword:supuidokyouka")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("supuidokyouka");
		}

		@Override
		public String getName() {
			return "effect.supuidokyouka";
		}
