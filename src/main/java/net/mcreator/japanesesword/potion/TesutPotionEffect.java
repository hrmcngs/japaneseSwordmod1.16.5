...
import net.mcreator.japanesesword.procedures.TesutehuekutogaYouXiaoShinoteitukuProcedure;
...
public class TesutPotionEffect {
	@ObjectHolder("japanesesword:tesut")
