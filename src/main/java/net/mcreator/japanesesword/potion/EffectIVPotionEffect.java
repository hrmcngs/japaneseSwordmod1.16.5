...
import net.mcreator.japanesesword.procedures.EffectIVposiyonXiaoGuogaQieretaShiProcedure;
import net.mcreator.japanesesword.procedures.EffectIVehuekutogaYouXiaoShinoteitukuProcedure;
...
public class EffectIVPotionEffect {
	@ObjectHolder("japanesesword:effect_iv")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("effect_iv");
		}

		@Override
		public String getName() {
			return "effect.effect_iv";
		}
