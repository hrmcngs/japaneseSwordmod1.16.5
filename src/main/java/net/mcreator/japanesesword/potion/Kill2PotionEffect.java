...
import net.mcreator.japanesesword.procedures.Kill2posiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure;
...
public class Kill2PotionEffect {
	@ObjectHolder("japanesesword:kill_2")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("kill_2");
		}

		@Override
		public String getName() {
			return "effect.kill_2";
		}
