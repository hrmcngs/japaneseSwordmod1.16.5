...
import net.mcreator.japanesesword.procedures.EffectIIIposiyonXiaoGuogaQieretaShiProcedure;
import net.mcreator.japanesesword.procedures.EffectIIIehuekutogaYouXiaoShinoteitukuProcedure;
...
public class EffectIIIPotionEffect {
	@ObjectHolder("japanesesword:effect_iii")
