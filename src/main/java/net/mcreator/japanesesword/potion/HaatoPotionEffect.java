...
import net.mcreator.japanesesword.procedures.HaatoposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure;
...
public class HaatoPotionEffect {
	@ObjectHolder("japanesesword:haato")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			super(EffectType.BENEFICIAL, -393216);
			setRegistryName("haato");
		}
