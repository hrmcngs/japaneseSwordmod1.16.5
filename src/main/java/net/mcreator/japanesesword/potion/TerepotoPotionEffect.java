...
import net.mcreator.japanesesword.procedures.TerepotoehuekutogaYouXiaoShinoteitukuProcedure;
...
public class TerepotoPotionEffect {
	...
	public static class EffectCustom extends Effect {
		...
		public void performEffect(LivingEntity entity, int amplifier) {
			...
			TerepotoehuekutogaYouXiaoShinoteitukuProcedure.executeProcedure(Stream
