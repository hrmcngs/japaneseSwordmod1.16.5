			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof ArrowEntity || entityiterator instanceof SpectralArrowEntity || entityiterator instanceof TridentEntity
					...
					if (!(entityiterator.getPosX() + entityiterator.getPosY() + entityiterator.getPosZ() == 0)) {
						if (entityiterator.getPersistentData().getBoolean("Check") == false) {
							entityiterator.getPersistentData().putBoolean("Check", (true));
							dis2 = Math.sqrt(Math.pow(entityiterator.getPosX() - entity.getPosX(), 0.8)
									+ Math.pow(entityiterator.getPosY() - entity.getPosY(), 0.8)
									+ Math.pow(entityiterator.getPosZ() - entity.getPosZ(), 0.8));
							if (dis2 <= 0.8) {
								entityiterator.getPersistentData().putBoolean("My arrow", (true));
							} else {
								entityiterator.getPersistentData().putBoolean("My arrow", (false));
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof ArrowEntity || entityiterator instanceof SpectralArrowEntity || entityiterator instanceof TridentEntity
					...
					if (!(entityiterator.getPosX() + entityiterator.getPosY() + entityiterator.getPosZ() == 0)) {
						if (entityiterator.getPersistentData().getBoolean("Check") == false) {
							entityiterator.getPersistentData().putBoolean("Check", (true));
							dis3 = Math.sqrt(Math.pow(entityiterator.getPosX() - entity.getPosX(), 1.2)
									+ Math.pow(entityiterator.getPosY() - entity.getPosY(), 1.2)
									+ Math.pow(entityiterator.getPosZ() - entity.getPosZ(), 1.2));
							if (dis3 <= 1.2) {
								entityiterator.getPersistentData().putBoolean("My arrow", (true));
							} else {
								entityiterator.getPersistentData().putBoolean("My arrow", (false));
						...
						if (entityiterator.getPersistentData().getBoolean("My arrow") == false) {
							if (entityiterator.getPersistentData().getBoolean("Check2") == false) {
								entityiterator.getPersistentData().putBoolean("Check2", (true));
								world.addParticle(ParticleTypes.SWEEP_ATTACK, (entityiterator.getPosX()),
										(entityiterator.getPosY() + MathHelper.nextDouble(new Random(), -0.1, 0.5)), (entityiterator.getPosZ()), 0, 1,
										0);
								{
									Entity _ent = entityiterator;
									if (!_ent.world.isRemote && _ent.world.getServer() != null) {
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof ArrowEntity || entityiterator instanceof SpectralArrowEntity || entityiterator instanceof TridentEntity
					...
					if (!(entityiterator.getPosX() + entityiterator.getPosY() + entityiterator.getPosZ() == 0)) {
						if (entityiterator.getPersistentData().getBoolean("Check") == false) {
							entityiterator.getPersistentData().putBoolean("Check", (true));
							dis4 = Math.sqrt(Math.pow(entityiterator.getPosX() - entity.getPosX(), 1.6)
									+ Math.pow(entityiterator.getPosY() - entity.getPosY(), 1.6)
									+ Math.pow(entityiterator.getPosZ() - entity.getPosZ(), 1.6));
							if (dis4 <= 1.6) {
								entityiterator.getPersistentData().putBoolean("My arrow", (true));
							} else {
								entityiterator.getPersistentData().putBoolean("My arrow", (false));
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof ArrowEntity || entityiterator instanceof SpectralArrowEntity || entityiterator instanceof TridentEntity
					...
					if (!(entityiterator.getPosX() + entityiterator.getPosY() + entityiterator.getPosZ() == 0)) {
						if (entityiterator.getPersistentData().getBoolean("Check") == false) {
							entityiterator.getPersistentData().putBoolean("Check", (true));
							dis5 = Math.sqrt(Math.pow(entityiterator.getPosX() - entity.getPosX(), 2)
