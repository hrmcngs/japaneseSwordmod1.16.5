...
import japanesesword.potion.Attack1PotionEffect;
...
public class DemonizedKatana1YoukuritukusitatokiProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency world for procedure DemonizedKatana1Youkuritukusitatoki!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency x for procedure DemonizedKatana1Youkuritukusitatoki!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency y for procedure DemonizedKatana1Youkuritukusitatoki!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency z for procedure DemonizedKatana1Youkuritukusitatoki!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency entity for procedure DemonizedKatana1Youkuritukusitatoki!");
			return;
		}
			...
			if (2 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
				...
				if (!(new Object() {
					...
					if (entity instanceof PlayerEntity)
						((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 10);
				}
			}
		}
		if ((entity.getCapability(JapaneseswordModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (2 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
				...
				if (!(new Object() {
					...
					if (entity instanceof PlayerEntity)
						((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 140);
				}
			}
		}
		if ((entity.getCapability(JapaneseswordModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (2 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
				...
				if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemOffhand() : ItemStack.EMPTY)
					...
					if (entity instanceof LivingEntity)
						((LivingEntity) entity).addPotionEffect(new EffectInstance(OriruPotionEffect.potion, (int) 40, (int) 1, (true), (false)));
					if (entity instanceof LivingEntity)
						((LivingEntity) entity).addPotionEffect(new EffectInstance(Attack1PotionEffect.potion, (int) 70, (int) 1, (true), (false)));
				} else {
					if (entity instanceof LivingEntity) {
						((LivingEntity) entity).swing(Hand.MAIN_HAND, true);
					}
					...
					for (int index1 = 0; index1 < (int) (5); index1++) {
						for (int index2 = 0; index2 < (int) (15); index2++) {
							if (world instanceof ServerWorld) {
								((ServerWorld) world).spawnParticle(ParticleTypes.SWEEP_ATTACK, (X + radiu * Math.sin(Math.toRadians(angle))),
										(y + 1), (Z + radiu * Math.sin(Math.toRadians(angle))), (int) 2, ((-0.1) * Math.sin(Math.toRadians(angle))),
										3, ((-0.1) * Math.cos(Math.toRadians(angle))), 1);
							}
						}
						{
							List<Entity> _entfound = world.getEntitiesWithinAABB(Entity.class,
				...
				if (!(new Object() {
					...
					if (entity instanceof PlayerEntity)
						((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 50);
				}
			}
		}
		if ((entity.getCapability(JapaneseswordModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (2 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
				...
				if (!(new Object() {
					...
					if (entity instanceof PlayerEntity)
						((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 7.5);
				}
			}
		}
		if ((entity.getCapability(JapaneseswordModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemOffhand() : ItemStack.EMPTY)
				...
				if (4 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
					...
					if (!(new Object() {
						...
						if (entity instanceof PlayerEntity)
							((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 40);
					}
				}
			} else {
				if (5 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
					...
					if (!(new Object() {
						...
						if (entity instanceof PlayerEntity)
							((PlayerEntity) entity).getCooldownTracker().setCooldown(BooktokubetuItem.block, (int) 25);
					}
				}
			}
		}
									...
									if (!(entityiterator == entity)) {
										if ((EnchantmentHelper.getEnchantmentLevel(KillEnchantment.enchantment,
											...
											if (entityiterator instanceof MobEntity) {
												if (((entity instanceof LivingEntity)
														? ((LivingEntity) entity).getHeldItemOffhand()
														: ItemStack.EMPTY).getItem() == DemonizedKatana1Item.block) {
													if ((EnchantmentHelper.getEnchantmentLevel(DemonizedEnchantment.enchantment,
															((entity instanceof LivingEntity)
																	? ((LivingEntity) entity).getHeldItemMainhand()
																	: ItemStack.EMPTY)) != 0)) {
													...
													if (entityiterator instanceof LivingEntity)
														((LivingEntity) entityiterator).addPotionEffect(
																new EffectInstance(BloodPotionEffect.potion, (int) 20, (int) 5, (true), (false)));
													entityiterator.attackEntityFrom(DamageSource.GENERIC, (float) ((10 * (1 + new Object() {
													...
													if (entityiterator instanceof LivingEntity)
														((LivingEntity) entityiterator).addPotionEffect(
																new EffectInstance(BloodPotionEffect.potion, (int) 20, (int) 5, (true), (false)));
													entityiterator.attackEntityFrom(DamageSource.GENERIC, (float) ((5 * (1 + new Object() {
														int check(Entity _entity) {
															if (_entity instanceof LivingEntity) {
																Collection<EffectInstance> effects = ((LivingEntity) _entity)
																		.getActivePotionEffects();
		...
		if ((entity.getCapability(JapaneseswordModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (5 < ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) || new Object() {
				...
				if (!(new Object() {
					...
					if (entity instanceof PlayerEntity)
						((PlayerEntity) entity).getCooldownTracker().setCooldown(DemonizedKatana1Item.block, (int) 25);
				}
				if (!(new Object() {
					public boolean checkGamemode(Entity _ent) {
						if (_ent instanceof ServerPlayerEntity) {
