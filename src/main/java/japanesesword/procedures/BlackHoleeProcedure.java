...
public class BlackHoleeProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency world for procedure BlackHolee!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency x for procedure BlackHolee!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency y for procedure BlackHolee!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency z for procedure BlackHolee!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				JapaneseswordMod.LOGGER.warn("Failed to load dependency entity for procedure BlackHolee!");
			return;
		}
		...
		sphereRadius = 20;
		{
			...
			for (Entity entityiterator : _entfound) {
				if (!(entityiterator instanceof BlackHoleEntity.CustomEntity) && !(entityiterator instanceof PlayerEntity)) {
				...
				if (!(entityiterator instanceof BlackHoleKillEntity.CustomEntity) && !(entityiterator instanceof PlayerEntity)) {
					dx = (entity.getPosX() - entityiterator.getPosX());
					dy = (entity.getPosY() - entityiterator.getPosY());
					dz = (entity.getPosZ() - entityiterator.getPosZ());
					sqaureDistance = (dx * dx + dy * dy + dz * dz);
