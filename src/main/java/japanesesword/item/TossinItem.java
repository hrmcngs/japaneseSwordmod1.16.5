...
import japanesesword.procedures.TossinFeibiDaoJugapureiyaniDangtatutatokiProcedure;
import japanesesword.procedures.TossinFeibiDaoJugaenteiteiniDangtatutatokiProcedure;
import japanesesword.procedures.TossinFeibiDaoJugaburotukuniDangtatutatokiProcedure;
import japanesesword.procedures.TossinFeibiDaoJugaFeindeiruJianProcedure;

import japanesesword.entity.renderer.TossinRenderer;
...
public class TossinItem extends JapaneseswordModElements.ModElement {
	...
	public TossinItem(JapaneseswordModElements instance) {
		super(instance, 313);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TossinRenderer.ModelRegisterHandler());
	}
