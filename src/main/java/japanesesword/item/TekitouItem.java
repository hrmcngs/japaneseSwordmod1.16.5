...
public class TekitouItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:tekitou_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:tekitou_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:tekitou_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:tekitou_boots")
	public static final Item boots = null;

	public TekitouItem(JapaneseswordModElements instance) {
		super(instance, 66);
	}
