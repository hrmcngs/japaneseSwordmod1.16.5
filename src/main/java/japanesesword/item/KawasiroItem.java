...
public class KawasiroItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:kawasiro_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:kawasiro_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:kawasiro_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:kawasiro_boots")
	public static final Item boots = null;

	public KawasiroItem(JapaneseswordModElements instance) {
		super(instance, 483);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{343, 343, 343, 343}[slot.getIndex()];
			}
