...
public class BlackStreyOuterArmorItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:black_strey_outer_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:black_strey_outer_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:black_strey_outer_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:black_strey_outer_armor_boots")
	public static final Item boots = null;

	public BlackStreyOuterArmorItem(JapaneseswordModElements instance) {
		super(instance, 472);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "black_strey_outer_armor";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(EventItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/models/armor/stray_outer_armor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
