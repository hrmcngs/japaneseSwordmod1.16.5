...
import japanesesword.procedures.MagickswordFeibiDaoJugaFeindeiruJianProcedure;

import japanesesword.entity.renderer.MagickswordRenderer;

import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class MagickswordItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:magicksword")
	...
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1)
			.setCustomClientFactory(ArrowCustomEntity::new).size(0.5f, 0.5f)).build("projectile_magicksword").setRegistryName("projectile_magicksword");

	public MagickswordItem(JapaneseswordModElements instance) {
		super(instance, 401);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MagickswordRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void tick() {
			...
			MagickswordFeibiDaoJugaFeindeiruJianProcedure.executeProcedure(
