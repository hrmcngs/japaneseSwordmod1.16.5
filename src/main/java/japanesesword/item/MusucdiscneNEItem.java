...
public class MusucdiscneNEItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:musucdiscne_ne")
	public static final Item block = null;

	public MusucdiscneNEItem(JapaneseswordModElements instance) {
		super(instance, 333);
	}
