...
import japanesesword.entity.renderer.NooooooRenderer;

import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class NooooooItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:noooooo")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_noooooo").setRegistryName("projectile_noooooo");

	public NooooooItem(JapaneseswordModElements instance) {
		super(instance, 473);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NooooooRenderer.ModelRegisterHandler());
	}
