...
import japanesesword.entity.renderer.BookBlackHoleRenderer;

import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class BookBlackHoleItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:book_black_hole")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_book_black_hole").setRegistryName("projectile_book_black_hole");

	public BookBlackHoleItem(JapaneseswordModElements instance) {
		super(instance, 379);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BookBlackHoleRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("book_black_hole");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			BookBlackHoleFeibiDaoJugaburotukuniDangtatutatokiProcedure.executeProcedure(Stream
		...
		public void tick() {
			...
			BookBlackHoleFeibiDaoJugaFeindeiruJianProcedure.executeProcedure(Stream
