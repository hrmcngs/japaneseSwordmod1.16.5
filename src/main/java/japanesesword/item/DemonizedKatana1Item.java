...
public class DemonizedKatana1Item extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:demonized_katana_1")
	public static final Item block = null;

	public DemonizedKatana1Item(JapaneseswordModElements instance) {
		super(instance, 407);
	}
