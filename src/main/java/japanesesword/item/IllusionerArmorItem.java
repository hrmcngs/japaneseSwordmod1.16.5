...
public class IllusionerArmorItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:illusioner_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:illusioner_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:illusioner_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:illusioner_armor_boots")
	public static final Item boots = null;

	public IllusionerArmorItem(JapaneseswordModElements instance) {
		super(instance, 519);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{5, 12, 15, 5}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(VillagerItemsItemGroup.tab)) {
			@Override
			@OnlyIn(Dist.CLIENT)
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				BipedModel armorModel = new BipedModel(1);
				armorModel.bipedHead = new Modelillusioner_armor_layer_3_Converted().head;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/entities/illusioner_armor_layer_3.png";
			}
		}.setRegistryName("illusioner_armor_helmet"));
		...
		}.setRegistryName("illusioner_armor_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(VillagerItemsItemGroup.tab)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/models/armor/illusioner_armor__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("illusioner_armor_leggings"));
		...
		}.setRegistryName("illusioner_armor_boots"));
	}
