...
public class BlackarmorItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:blackarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:blackarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:blackarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:blackarmor_boots")
	public static final Item boots = null;

	public BlackarmorItem(JapaneseswordModElements instance) {
		super(instance, 389);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("blackarmor_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(ItemGroup.COMBAT)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/models/armor/black_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("blackarmor_leggings"));
