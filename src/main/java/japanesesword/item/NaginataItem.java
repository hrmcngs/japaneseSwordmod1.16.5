...
public class NaginataItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:naginata")
	public static final Item block = null;

	public NaginataItem(JapaneseswordModElements instance) {
		super(instance, 275);
	}
