...
public class VindicatorArmorItem extends JapaneseswordModElements.ModElement {
	@ObjectHolder("japanesesword:vindicator_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("japanesesword:vindicator_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("japanesesword:vindicator_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("japanesesword:vindicator_armor_boots")
	public static final Item boots = null;

	public VindicatorArmorItem(JapaneseswordModElements instance) {
		super(instance, 517);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{6, 15, 18, 8}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(VillagerItemsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/entities/vindicator_layer_3.png";
			}
		}.setRegistryName("vindicator_armor_chestplate"));
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.LEGS, new Item.Properties().group(VillagerItemsItemGroup.tab)) {
			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "japanesesword:textures/models/armor/vindicator__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("vindicator_armor_leggings"));
		...
		}.setRegistryName("vindicator_armor_boots"));
	}
