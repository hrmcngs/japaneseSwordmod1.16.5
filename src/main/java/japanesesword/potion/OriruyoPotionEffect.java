...
import japanesesword.procedures.OriruyoposiyonXiaoGuogaQieretaShiProcedure;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class OriruyoPotionEffect {
	@ObjectHolder("japanesesword:oriruyo")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("oriruyo");
		}

		@Override
		public String getName() {
			return "effect.oriruyo";
		}
		...
		public void applyAttributesModifiersToEntity(LivingEntity entity, AttributeModifierManager attributeMapIn, int amplifier) {
			...
			OriruyoposiyonXiaoGuogaQieretaShiProcedure
