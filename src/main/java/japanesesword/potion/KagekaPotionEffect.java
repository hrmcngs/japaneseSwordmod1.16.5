...
import japanesesword.procedures.KagekaposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure;
import japanesesword.procedures.KagekaposiyonXiaoGuogaQieretaShiProcedure;
import japanesesword.procedures.KagekaehuekutogaYouXiaoShinoteitukuProcedure;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class KagekaPotionEffect {
	@ObjectHolder("japanesesword:kageka")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			...
			setRegistryName("kageka");
		}

		@Override
		public String getName() {
			return "effect.kageka";
		}
