...
import japanesesword.procedures.SliceposiyonnoXiaoGuogaKaiShiShiYongsaretatokiProcedure;
import japanesesword.procedures.SliceehuekutogaYouXiaoShinoteitukuProcedure;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class SlicePotionEffect {
	@ObjectHolder("japanesesword:slice")
