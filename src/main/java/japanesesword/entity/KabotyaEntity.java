...
import japanesesword.item.Halloween20221031Item;

import japanesesword.entity.renderer.KabotyaRenderer;

import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class KabotyaEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("kabotya").setRegistryName("kabotya");

	public KabotyaEntity(JapaneseswordModElements instance) {
		super(instance, 421);
		FMLJavaModLoadingContext.get().getModEventBus().register(new KabotyaRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -39424, -10066330, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("kabotya_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Halloween20221031kamaItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Halloween20221031kamaItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Halloween20221031Item.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(Halloween20221031Item.body));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(Halloween20221031Item.legs));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(Halloween20221031Item.boots));
