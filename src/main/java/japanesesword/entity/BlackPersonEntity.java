...
import net.miBlackPersonEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 0.4f)).build("magic_katana").setRegistryName("magic_katana");

	public BlackPersonEntity.NgsoItem;
import japanesesword.item.NgskItem;
import japanesesword.item.HanyouItem;

import japanesesword.entity.renderer.BlackPersonRenderer;
import japanesesword.entity.renderer.BlackPersonRenderer.ModelRegisterHandler;
import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class BlackPersonEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("black_person").setRegistryName("black_person");

	public BlackPersonEntity(JapaneseswordModElements instance) {
		super(instance, 419);
		MLJavaModLoadingContext.get().getModEventBus().register(new BlackPersonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("black_person_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(NgsoItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(NgskItem.block));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(HanyouItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(HanyouItem.body));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(HanyouItem.legs));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(HanyouItem.boots));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TiItem.block));
		}
