...
import japanesesword.entity.renderer.DokunosukeltonRenderer;

import japanesesword.JapaneseswordModElements;

@JapaneseswordModElements.ModElement.Tag
public class DokunosukeltonEntity extends JapaneseswordModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("dokunosukelton").setRegistryName("dokunosukelton");

	public DokunosukeltonEntity(JapaneseswordModElements instance) {
		super(instance, 338);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DokunosukeltonRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -14846720, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("dokunosukelton_spawn_egg"));
	}
